import{d as t}from"./base-49bd4703.js";import"./translated-string-211358df.js";import"./custom-container-b8612822.js";import"./custom-input-7bdb41b0.js";import"./image-mixin-3ab70175.js";import{P as s}from"./product-editor-mixin-3cc75949.js";export default t(class TopProduct extends s{set value(t){this._value=t,this.rendered&&this.stamp()}constructor(){super(),this.ref="products"}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this._value&&this.stamp()}stamp(){this.innerHTML="",this.nails.innerHTML="",firebase.database().ref(`products/${this._value}`).once("value").then(t=>{const s=t.val();console.log({value:s});for(const t of Object.keys(s)){console.log(s[t]);let e=s[t];if("image"===t)"object"==typeof e&&(e=[...Object.entries(e)]),Array.isArray(e)||(e=[e]),e.forEach(([t,s])=>{console.log(t,s),this.nails.add({key:t,src:`https://ipfs.io/ipfs/${s}`})});else if("packageCount"!==t){this.shadowRoot.querySelector(`custom-input[name="${t}"]`).value=e}else this.packageCount=e}this.render({packageCount:this.packageCount})})}get template(){return html`
<style>
  :host {
    display: flex;
