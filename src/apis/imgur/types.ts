...
export declare type imgurAlbumParams = { ids?:  imgurImageHash[], title: string, description: string, cover?: imgurImageHash }
...
export declare type imgurImageParams = {image: string, title: string, description: string, album?: string, type: imgurImageUploadType, disable_audio?: boolean}
